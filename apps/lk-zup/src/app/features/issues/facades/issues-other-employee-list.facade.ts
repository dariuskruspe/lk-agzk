...
import { IssuesOtherEmployeeListState } from '../states/issues-other-employee-list.state';

@Injectable({
  providedIn: 'root',
})
export class IssuesOtherEmployeeListFacade extends AbstractFacade<IssuesListInterface> {
  constructor(
    protected geRx: GeRx,
    protected store: IssuesOtherEmployeeListState,
