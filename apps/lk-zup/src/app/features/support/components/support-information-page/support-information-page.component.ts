...
@Component({
    selector: 'app-support-information-page',
    templateUrl: './support-information-page.component.html',
    styleUrls: ['./support-information-page.component.scss'],
    standalone: false
})
export class SupportInformationPageComponent implements OnChanges {
